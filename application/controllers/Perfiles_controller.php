...
//carga una vista llamada list
	...
	public function view($id){
		$data = array(
			'perfiles' => $this->Perfiles_model->getPerfil($id),
		 );
			$this->load->view("perfiles/view",$data);
	}

	public function store(){
		$this->form_validation->set_rules("descripcion","Campo descripcion","required|is_unique[perfil.descripcion]");
	...
	public function update()
	{
		...
		$id_bd = $this->Perfiles_model->getPerfil($id);
		...
		{	
			...
			$unique = '|is_unique[perfil.descripcion]';
		}
