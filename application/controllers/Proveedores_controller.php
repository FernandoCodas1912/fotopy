...
//carga una vista llamada list
	...
	public function store(){
		...
		$this->form_validation->set_rules("nrodocumento","Nro de Documento","required|is_unique[proveedor.nrodocumento]");
	...
	public function update()
	{
		...
		$nrodocumentoBd = $this->Proveedores_model->getProveedor($id);
		...
		{	
			...
			$unique = '|is_unique[proveedor.nrodocumento]';
		}
