...
//carga una vista llamada list
	...
	public function view($id){
		$data = array(
			'comprobantes' => $this->Comprobantes_model->getComprobante($id),
		 );
	...
	public function update()
	{
		...
		$edit_serie_comprobante     = $this->input->post("edit_serie_comprobante");
		$edit_ultimo_nro     = $this->input->post("edit_ultimo_nro");
	
		//traemos datos para no duplicarlos
		$id_bd = $this->Comprobantes_model->getComprobante($id);
