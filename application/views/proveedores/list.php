                ...
                <div class="card-box">
                    <div class="col-md-2 pull-right">
                        <a href="" class="btn btn-success" data-toggle="modal" data-target="#modal-agregar"><i
                                class="fa fa-plus"></i> <span> Nuevo Proveedor</span> </a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-success btn-xs btn-ver" data-toggle="modal"
                                            data-target="#modal-ver" value="<?php echo $proveedor->id_proveedor; ?>"
                                            title="Ver Detalles">
                                            <i class="fa fa-eye">
                                            </i> Ver
                                        </button>
                                        ...
                                        <button type="button" class="btn btn-warning btn-xs btn-editar"
                                            ...
                                            value="<?php echo $proveedor->id_proveedor; ?>" title="Editar Detalles">
                                            <i class="fa fa-pencil">
                                            </i> Editar
                                        </button>

                                        <a href="<?php echo base_url(); ?>Proveedores_controller/delete/<?php echo $proveedor->id_proveedor; ?>"
                                            class="btn btn-xs btn-danger btn-delete" title="Inactivar proveedor">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="<?php echo base_url(); ?>Proveedores_controller/store" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="timesheetinput1" class="form-control"
                                        placeholder="Nombre de proveedor" name="razonsocial" required="">
    ...
    <div class="modal" id="modal-editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>Proveedores_controller/update" method="POST" id="formEdit"
                    name="formEdit">
                    <div class="modal-body">
