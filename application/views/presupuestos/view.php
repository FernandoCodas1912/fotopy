...
<div class="content-page">
	...
	<div class="content">
		...
		<div class="card-box">
			<!--inicio card box -->
			<h4 class="header-title m-t-0 m-b-30">Operacion Nro. <?php echo $venta->id_venta; ?> </h4>
			<div class="form-group row">
				<form class="form" role="form" id="ventas" action="<?php echo base_url(); ?>Ventas_controller/view" method="post">
					...
					<div class="pull-right">
						...
						<a href="<?php echo base_url(); ?>Ventas_controller/delete/<?php echo $venta->id_venta; ?>" <button type="button" class="btn btn-danger btn-sm btn-delete" value="<?php echo $venta->id_venta; ?>" title="Anular"><i class="fa fa-trash-o"></i> Anular
							</button>
						</a>

						<a href="<?php echo base_url(); ?>Ventas_controller" <button type="button" class="btn btn-primary btn-sm" title="Regresar al listado"><i class="fa fa-arrow-left"></i> Regresar
							</button>
						</a>
					</div>
					<br>
						...
						<div class="modal-dialog modal-xs" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">COMPROBANTE DE LA OPERACION</h4>
								</div>
