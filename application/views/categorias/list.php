                ...
                <div class="card-box">
                    <div class="col-md-2 pull-right">
                        <a href="" class="btn btn-success btn-md btn-block" data-toggle="modal"
                            data-target="#modal-agregar"><i class="fa fa-plus"></i> <span> Nueva Categoria</span> </a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php
                                            ...
                                            ?>
                                    <td><span class="label <?php echo $label_class2; ?>"><?php echo $tipo2; ?></span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-success btn-sm btn-ver" data-toggle="modal"
                                            data-target="#modal-ver" value="<?php echo $categoria->id_categoria; ?>"
                                            title="Ver Detalles de la categoria">
                                            <i class="fa fa-eye">
                                            </i> Ver
                                        </button>
                                        <!-- usa del modelo la funcion correspondiente -->
                                        <button type="button" class="btn btn-warning btn-sm btn-editar"
                                            ...
                                            title="Editar Detalles de la categoria">
                                            <i class="fa fa-pencil">
                                            </i> Editar
                                        </button>

                                        <a href="<?php echo base_url(); ?>Categorias_controller/delete/<?php echo $categoria->id_categoria; ?>"
                                            class="btn btn-sm btn-danger btn-delete" title="Inactivar categoria">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="<?php echo base_url(); ?>Categorias_controller/store" method="POST"
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="timesheetinput1" class="form-control"
                                        placeholder="Descripcion completa de la Categoria" name="descripcion"
                                        required="">
                            ...
                            <div class="form-group">
                                <label for="projectinput5">Esta Categoria es para </label>
                                <select id="projectinput5" name="tipo" class="form-control" required="">
    ...
    <div class="modal" id="modal-editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>Categorias_controller/update" method="POST" id="formEdit"
                    name="formEdit">
                    <div class="modal-body">
