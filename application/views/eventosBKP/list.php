		...
		<div class="row">
			<div class="col-lg-12">
				<div class="card-box">
					...
					<h4 class="header-title m-t-0 m-b-30"> Listado de Tipo de Evento</h4>
									...
									<?php foreach($eventos as $evento):?>
										<tr>
											...
											<td>
												...
												<button type="button" class="btn btn-success btn-xs btn-ver" data-toggle="modal" data-target="#modal-ver" value="<?php echo $evento->id_tipoevento;?>" title="Ver Detalles del tipo de evento">
													<i class="fa fa-eye">
													</i> Ver
												</button>
												<!-- usa del modelo la funcion correspondiente -->
												<button type="button" class="btn btn-warning btn-xs btn-editar" data-toggle="modal" data-target="#modal-editar" value="<?php echo $evento->id_tipoevento;?>" title="Editar Detalles del tipo de evento">
													<i class="fa fa-pencil">
													</i> Editar
												</button>

												<a href="<?php echo base_url();?>Eventos_controller/delete/<?php echo $evento->id_tipoevento;?>" class="btn btn-xs btn-danger btn-delete" title="Inactivar tipo de evento">
