	...
	<div class="content">	<!-- Start content -->
		...
		<div class="card-box"><!--inicio card box -->
			...
			<div class="form-group row">
				<form class="form-horizontal" role="form" id="datos_factura_ventas" action="<?php echo base_url();?>Ventas_controller/store" method="post">		
					...
					<div class="form-group">				
						...
						<select class='form-control' name="id_tipocomprobante" id="id_tipocomprobante" required>
										...
										<option value="<?php echo $datacomprobante; ?>"> <?php echo $comprobante->id_comprobante . "-" . $comprobante->descripcion; ?> </option>
										<?php } ?>
										<?php endforeach; ?>
									</select>
						</div>
							...
							<div class="col-md-2 pull-right">
								<div class="input-group m-t-10">
									<button type="submit" class="btn btn-success" id="">
										<span class="glyphicon glyphicon-save"></span> Guardar Venta
									</button>
								</div>
							</div>
						</div> <!-- form-group -->
