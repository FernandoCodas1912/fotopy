			...
			<div class="col-lg-12">
				<div class="card-box">
					<div class="col-md-2 pull-right">
						<a href="" class="btn btn-success"  data-toggle="modal" data-target="#modal-agregar"><i class="fa fa-plus"></i> <span> Nuevo Producto/Servicio</span> </a>
					</div>
									...
									<?php foreach($servicios as $servicio):?>
										<tr>
											...
											<td>
												...
												<button type="button" class="btn btn-success btn-xs btn-ver" data-toggle="modal" data-target="#modal-ver" value="<?php echo $servicio->id_producto;?>" title="Ver Detalles del servicio">
													<i class="fa fa-eye">
													</i> Ver
												</button>
												<!-- usa del modelo la funcion correspondiente -->
												<button type="button" class="btn btn-warning btn-xs btn-editar" data-toggle="modal" data-target="#modal-editar" value="<?php echo $servicio->id_producto;?>" title="Editar Detalles del servicio">
													<i class="fa fa-pencil">
													</i> Editar
												</button>

												<a href="<?php echo base_url();?>servicios_controller/delete/<?php echo $servicio->id_producto;?>" class="btn btn-xs btn-danger btn-delete" title="Inactivar servicio">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title" id="exampleModalLabel2">NUEVO PRODUCTO/SERVICIO</h5>
                        </div>
                        <div class="modal-body">
                            <form class="form" action="<?php echo base_url();?>Servicios_controller/store" method="POST" id="formAdd" name="formAdd" >
                                <div class="form-body">
                                    <h4 class="form-section"><i class="icon-ios-albums"></i> Datos Basicos</h4>
                                    <div class="form-group">
                                        <label for="timesheetinput1">Codigo</label>
                                        <div class="position-relative has-icon-left">
                                            <input type="text" id="timesheetinput1" class="form-control" placeholder="Codigo de Barra" name="codigobarra" required="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <input type="text" id="timesheetinput1" class="form-control" placeholder="Descripcion completa del Producto o Servicio" name="descripcion" required="">
                                            <div class="form-control-position">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="timesheetinput1">Stock Inicial</label>
                                                <div class="position-relative has-icon-left">
                                                    <input type="text" id="timesheetinput1" class="form-control" placeholder="Stock Inicial" name="stock" required="" value="0">
                                                    <div class="form-control-position">
                                            ...
                                            <div class="form-group">
                                                <label for="timesheetinput1">Precio Compra</label>
                                                 <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Precio de compra" aria-label="Ingrese precio en Gs." name="precio_compra">
                                                 </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="timesheetinput1">Precio Venta</label>
                                                 <div class="input-group">
                                                    <span class="input-group-addon">Gs.</span>
                                                    <input type="text" class="form-control" placeholder="Precio de Venta" aria-label="Ingrese precio en Gs." name="precio_venta">
                                                 </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal" id="modal-editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url();?>Servicios_controller/update" method="POST" id="formEdit" name="formEdit" >
                    <div class="modal-body">
