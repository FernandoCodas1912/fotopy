    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="position-relative has-icon-left">
                <input type="text" id="timesheetinput1" class="form-control" value="<?php echo $servicios->stock; ?>" placeholder="Stock Inicial" name="edit_stock" required="" value="0">
                <div class="form-control-position">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Precio de compra" value="<?php echo $servicios->precio_compra; ?>" aria-label="Ingrese precio en Gs." name="edit_precio_compra">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                <span class="input-group-addon">Gs.</span>
                <input type="text" class="form-control" placeholder="Precio de Venta" value="<?php echo $servicios->precio_venta; ?>" aria-label="Ingrese precio en Gs." name="edit_precio_venta">
            </div>
        </div>
    </div>
</div>
