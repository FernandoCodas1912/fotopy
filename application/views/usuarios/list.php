...
<div class="content-page">
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="col-md-2 pull-right">
                        <a href="" class="btn btn-success" data-toggle="modal" data-target="#modal-agregar"><i class="fa fa-plus"></i> <span> Nuevo Usuario</span> </a>
                    </div>
                                    ...
                                    <?php foreach ($usuarios as $usuario) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary btn-xs btn-cambio_clave" data-toggle="modal" data-target="#modal-cambio_clave" value="<?php echo $usuario->id_usuario; ?>" title="Cambiar Clave">
                                                    <i class="fa fa-lock">
                                                    </i> Cambiar Clave
                                                </button>
                                                <!-- usa del modelo la funcion correspondiente -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <input type="text" id="timesheetinput1" class="form-control" placeholder="Nombre de usuario" name="username" required="">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <input type="password" id="timesheetinput1" class="form-control" placeholder="clave" name="clave" required="">
                                            <div class="form-control-position">
                                                <i class="icon-lock"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <input type="password" id="timesheetinput1" class="form-control" placeholder="Repetir clave" name="repetirclave" required="">
                                            <div class="form-control-position">
                                                <i class="icon-lock"></i>
                                            </div>
                                        </div>
    ...
    <!-- MODAL CAMBIAR CLAVE-->
    <div class="modal" id="modal-cambio_clave" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form class="form" action="<?php echo base_url(); ?>Usuarios_controller/update_password" method="POST" id="formUpdatePassword" name="formUpdatePassword">
                    <div class="modal-body">
