                ...
                <div class="card-box">
                    <div class="col-md-2 pull-right">
                        <a href="" class="btn btn-success btn-md btn-block" data-toggle="modal"
                            data-target="#modal-agregar"><i class="fa fa-plus"></i> <span> Nuevo Empleado</span> </a>
                    </div>
                    <h4 class="header-title m-t-0 m-b-30"> Listado del Staff</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-success btn-sm btn-ver" data-toggle="modal"
                                            data-target="#modal-ver" value="<?php echo $empleado->id_empleado; ?>"
                                        ...
                                        <button type="button" class="btn btn-warning btn-sm btn-editar"
                                            ...
                                            title="Editar Detalles del empleado">
                                            <i class="fa fa-pencil">
                                            </i> Editar
                                        </button>

                                        <a href="<?php echo base_url(); ?>Empleados_controller/delete/<?php echo $empleado->id_empleado; ?>"
                                            class="btn btn-sm btn-danger btn-delete" title="Inactivar empleado">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="<?php echo base_url(); ?>Empleados_controller/store" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-left">
                                    <input type="text" id="timesheetinput1" class="form-control"
                                        placeholder="Nombre y Apellido" name="nomape" required="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <input type="text" id="timesheetinput1" class="form-control"
                                                placeholder="Documento" name="nrodocumento" required="">
                                            <div class="form-control-position">
                                                <i class="icon-android-cart"></i>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="position-relative has-icon-left">
                                            <input type="number" min="0" id="timesheetinput1" class="form-control"
                                                placeholder="Salario" name="salario" required="">
                                            <div class="form-control-position">
                                                <i class="icon-android-cart"></i>
                                            </div>
                                        </div>
    ...
    <div class="modal" id="modal-editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>Empleados_controller/update" method="POST" id="formEdit"
                    name="formEdit">
                    <div class="modal-body">
